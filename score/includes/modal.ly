...
%%%   csoaa4^\markup \center-column { "5" "-14" }
  ...
  %%%%%%%%%% 1 %%%%%%%%%%%
  	  % 4/4
	     \cue "23"
  <csoaa'' fsoda'' gsoaa'>1\arpeggio\sustainOn
  %%%%%%%%%% 2 %%%%%%%%%%%
  	  | %2
  r2
  ...
  |
	     \cue "24"
  <fsoda' gsoaa' doba''>2.\arpeggio\sustainOn
  r4
  %%%%%%%%%% 6 %%%%%%%%%%%
  |
  r4
